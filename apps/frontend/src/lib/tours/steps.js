export const gesturesSteps = [
...

  {
    ...
    title: "Drone Mode",
    content:
      "Switch between DroneSim, Manual, and Autonomous - this decides which adapter you are connected to.",
  },
...

  {
    ...
    title: "Gesture Guide",
    content:
      "A reference for every gesture the system recognizes, plus manual command buttons.",
  },
...
export const analyticsSteps = [
...

  {
    ...
    content:
      "Duration of your most recent completed flights pulled from the database",
  },
