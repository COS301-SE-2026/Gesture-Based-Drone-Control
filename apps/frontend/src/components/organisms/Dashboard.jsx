                            ...
                            <div className="grid grid-cols-2 gap-6">
                                ...
                                <div className="flex flex-cols items-center gap-6">
                                    ...
                                    <div className="text-center">
                                        <p className="text-xs text-OffBlack uppercase mb-1">Battery</p>
                                        <p className="text-xl font-bold text-OffBlack dark:text-OffWhite">{droneMetrics.battery}%</p>
                                    </div>
                                </div>
                                {/* signal */}
                                <div className="flex flex-cols items-center gap-6">
                                    ...
                                    <div className="text-center">
                                        <p className="text-xs text-OffBlack uppercase mb-1">Signal</p>
                                        <p className="text-xl font-bold text-OffBlack dark:text-OffWhite">{droneMetrics.signal}%</p>
                                    </div>
                                </div>
                                {/* speed */}
                                <div className="flex flex-cols items-center gap-6">
                                    ...
                                    <div className="text-center">
                                        <p className="text-xs text-OffBlack uppercase mb-1">Speed</p>
                                        <p className="text-xl font-bold text-OffBlack dark:text-OffWhite">{droneMetrics.speed} km/h</p>
                                    </div>
                                </div>
                                {/* altitude */}
                                <div className="flex flex-cols items-center gap-6">
                                    ...
                                    <div className="text-center">
                                        <p className="text-xs text-OffBlack uppercase mb-1">Altitude</p>
                                        <p className="text-xl font-bold text-OffBlack dark:text-OffWhite">{droneMetrics.altitude}m</p>
                                    </div>
                                </div>  
                            </div> 
                        </div>
                ...
                <Card variant="glass">
                    <div className="relative w-full h-96 bg-OffBlack/50 rounded-lg border border-Grey/20 overflow-hidden">
                        <div className="w-full h-full bg-gradient-to-b from-OffBlack/30 to-OffBlack/50 flex items-center justify-center relative">
                            ...
                            <span className="w-2 h-2 bg-Red rounded-full animate-pulse" />02:12
                            </div>
                        </div>
                    </div>
                </Card>
