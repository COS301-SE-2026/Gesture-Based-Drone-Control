    ...
    return (
        <div className="space-y-6">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <ResponsiveContainer width="100%" height={220}>
                            <LineChart data={flightTelemetryData}>
                                ...
                                <XAxis dataKey="time" stroke="#B1A7A6" style={{ fontSize: '12px'}} />
            ...
            <Card variant="glass">
                    <div className="flex flex-col gap-4">
                        ...
                        <ResponsiveContainer width="100%" height={280}>
                            <BarChart data={performanceData}>
                                <CartesianGrid stroke="#D3D3D3" opacity={0.1} />
                                <XAxis dataKey="flight" stroke="#B1A7A6" style={{ fontSize: '12px'}} />
                                <YAxis stroke="#B1A7A6" style={{ fontSize: '12px'}} />
                                <Tooltip 
                                    contentStyle= {{
                                        backgroundColor: '#D3D3D3',
                ...
                <Card variant="glass">
                    <div className="text-center">
                        <p className="text-xs text-DarkGrey uppercase">Average Flight Duration</p>
                        <div className="flex items-baseline gap-1">
                            <span className="text-2xl font-bold text-OffBlack dark:text-OffWhite">
