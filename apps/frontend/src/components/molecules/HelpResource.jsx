  ...
  return (
    <section className="grid gap-4 sm:grid-cols-2">
      <Card variant="glass" className="flex item-center justify-between gap-6">
        ...
        <Button variant="secondary" size="lg" onClick={onOpenManual} aria-label= "User Manual">
          <ArrowRightCircle />
        </Button>
      </Card>
      ...
      <Card variant="glass" className="flex item-center justify-between gap-6">
        ...
        <Button variant="secondary" size="lg" onClick={onOpenTut} aria-label= "Get started tutorial">
          <ArrowRightCircle />
        </Button>
      </Card>
    </section>
