        ...
        <Card variant="glass" className={className}>
            <div className="flex flex-col gap-3">
                <div className="flex items-center justify-between gap-4">
                    ...
                    >
                        <span className={`inline-block h-4 w-4 transform rounded-full bg-OffWhite transition-transform 
                        duration-200 ${
                ...
                <p className="text-xs text-DarkGrey">
                    Status:{" "}
                    <span
                        className={enabled ? "text-green-500" : "text-OffBlack dark:text-OffWhite"}
                    >
