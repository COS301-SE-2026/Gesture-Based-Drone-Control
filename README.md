...
<a href="#codex-merchants">
  <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=20&pause=900&color=E5383B&center=true&vCenter=true&width=820&lines=Hand+gestures+become+real-time+drone+commands;Computer+vision+%C2%B7+MediaPipe+%C2%B7+Rule-based+classification;Live+camera%2C+landmark+detection%2C+flight;Calibrate+first+%C2%B7+Hover+on+loss+%C2%B7+Emergency+override" alt="Project tagline"/>
</a>
...
[![Python](https://img.shields.io/badge/Python-3.11-A4161A?style=flat-square&logo=python&logoColor=F5F3F4&labelColor=161A1D)](https://python.org)
[![FastAPI](https://img.shields.io/badge/FastAPI-0.136-A4161A?style=flat-square&logo=fastapi&logoColor=F5F3F4&labelColor=161A1D)](https://fastapi.tiangolo.com)
[![MediaPipe](https://img.shields.io/badge/MediaPipe-0.10.21-A4161A?style=flat-square&logo=google&logoColor=F5F3F4&labelColor=161A1D)](https://mediapipe.dev)
[![React](https://img.shields.io/badge/React-18-A4161A?style=flat-square&logo=react&logoColor=F5F3F4&labelColor=161A1D)](https://react.dev)
[![Vite](https://img.shields.io/badge/Vite-8-A4161A?style=flat-square&logo=vite&logoColor=F5F3F4&labelColor=161A1D)](https://vite.dev)
[![PostgreSQL](https://img.shields.io/badge/PostgreSQL-16-A4161A?style=flat-square&logo=postgresql&logoColor=F5F3F4&labelColor=161A1D)](https://postgresql.org)
[![uv](https://img.shields.io/badge/uv-workspace-A4161A?style=flat-square&logo=astral&logoColor=F5F3F4&labelColor=161A1D)](https://docs.astral.sh/uv/)
[![Task](https://img.shields.io/badge/Task-runner-A4161A?style=flat-square&logo=task&logoColor=F5F3F4&labelColor=161A1D)](https://taskfile.dev)
...
<tr>
  <td align="center" width="20%">
    <a href="https://github.com/Ayush-B99">
      <img src="https://github.com/Ayush-B99.png?size=120" width="90" style="border-radius:50%" alt="Ayush"/>
    </a>
    <br/>
    <b>Ayush Beekum</b><br/>
  ...
  <td align="center" width="20%">
    <a href="https://github.com/ShavirV">
      <img src="https://github.com/ShavirV.png?size=120" width="90" style="border-radius:50%" alt="Shavir"/>
    </a>
    <br/>
  ...
  <td align="center" width="20%">
    <a href="https://github.com/Wave2055">
      <img src="https://github.com/Wave2055.png?size=120" width="90" style="border-radius:50%" alt="Jaitin"/>
    </a>
    <br/>
  ...
  <td align="center" width="20%">
    <a href="https://github.com/deexglitch">
      <img src="https://github.com/deexglitch.png?size=120" width="90" style="border-radius:50%" alt="Diya"/>
    </a>
    <br/>
    <b>Diya Narotam</b><br/>
  ...
  <td align="center" width="20%">
    <a href="https://github.com/ChinmayiSanthosh">
      <img src="https://github.com/ChinmayiSanthosh.png?size=120" width="90" style="border-radius:50%" alt="Chinmayi"/>
    </a>
    <br/>
...
%%{init: {'theme':'dark', 'themeVariables': {
  ...
  'actorBkg':'#161A1D','actorBorder':'#A4161A','actorTextColor':'#F5F3F4',
  'signalColor':'#E5383B','signalTextColor':'#F5F3F4',
  'background':'#0B090A','noteBkgColor':'#161A1D','noteTextColor':'#F5F3F4','noteBorderColor':'#A4161A'
}}}%%
sequenceDiagram
    participant User
    participant Camera
    participant HandDetection
    participant GestureEngine
    participant Stabilizer
    participant Calibration
    participant FastAPI
    participant DroneAdapter
    participant Dashboard

    User->>Camera: Performs gesture
    Camera->>HandDetection: Frame
    HandDetection->>GestureEngine: 21 landmarks
    GestureEngine->>GestureEngine: Rule based classify
    GestureEngine->>Stabilizer: Raw gesture
    Stabilizer->>Calibration: Majority voted gesture
    Calibration-->>FastAPI: Gate open once calibrated
    FastAPI->>DroneAdapter: Translated command
    DroneAdapter-->>FastAPI: Telemetry
    FastAPI-->>Dashboard: WebSocket push
    Dashboard-->>User: Live status update

    Note over Stabilizer,FastAPI: Safety layer hovers on tracking loss
```
...
<img src="https://skillicons.dev/icons?i=python,fastapi,opencv,postgres,sqlite,react,vite,tailwind,typescript,nodejs,electron,github,githubactions,git,vscode&perline=16" alt="Tech stack"/>
...
|:---|:---|:---:|
| ![Python](https://img.shields.io/badge/-Python-A4161A?style=flat-square&logo=python&logoColor=F5F3F4&labelColor=161A1D) | Primary language. CV, services, drone SDK integration | `3.11.x` |
| ![OpenCV](https://img.shields.io/badge/-OpenCV-A4161A?style=flat-square&logo=opencv&logoColor=F5F3F4&labelColor=161A1D) | Live camera feed and image preprocessing | `4.8+` |
| ![MediaPipe](https://img.shields.io/badge/-MediaPipe-A4161A?style=flat-square&logo=google&logoColor=F5F3F4&labelColor=161A1D) | Real time 21-point hand landmark detection and tracking | `0.10.21` |
| ![NumPy](https://img.shields.io/badge/-NumPy-A4161A?style=flat-square&logo=numpy&logoColor=F5F3F4&labelColor=161A1D) | Vector math. Angles, distances, finger state | `1.26+` |
...
| Technology | Purpose | Version |
|:---|:---|:---:|
| ![FastAPI](https://img.shields.io/badge/-FastAPI-A4161A?style=flat-square&logo=fastapi&logoColor=F5F3F4&labelColor=161A1D) | REST plus WebSocket API (ASGI), Swagger at `/docs` | `0.136+` |
| ![SQLAlchemy](https://img.shields.io/badge/-SQLAlchemy-A4161A?style=flat-square&logo=sqlalchemy&logoColor=F5F3F4&labelColor=161A1D) | Async ORM. Models and managers in `services/database_manager` | `2.0+` |
| ![PostgreSQL](https://img.shields.io/badge/-PostgreSQL-A4161A?style=flat-square&logo=postgresql&logoColor=F5F3F4&labelColor=161A1D) | Primary database via `asyncpg`. Bootstrapped by `init-db/` | `16` |
| ![SQLite](https://img.shields.io/badge/-SQLite-A4161A?style=flat-square&logo=sqlite&logoColor=F5F3F4&labelColor=161A1D) | Local and test database via `aiosqlite` | `3.x` |
| ![Pydantic](https://img.shields.io/badge/-Pydantic-A4161A?style=flat-square&logo=pydantic&logoColor=F5F3F4&labelColor=161A1D) | Schemas, validation, settings (`pydantic-settings`) | `2.13+` |
| PyJWT plus bcrypt | Access and refresh tokens, password hashing, HTTP-only cookies | `latest` |
| ![Pytest](https://img.shields.io/badge/-Pytest-A4161A?style=flat-square&logo=pytest&logoColor=F5F3F4&labelColor=161A1D) | Unit, integration and API testing. `pytest-asyncio` in auto mode | `9.x` |
...
| Technology | Purpose | Version |
|:---|:---|:---:|
| ![React](https://img.shields.io/badge/-React-A4161A?style=flat-square&logo=react&logoColor=F5F3F4&labelColor=161A1D) | Dashboard UI. Atomic design, JSX | `18` |
| ![Vite](https://img.shields.io/badge/-Vite-A4161A?style=flat-square&logo=vite&logoColor=F5F3F4&labelColor=161A1D) | Dev server and bundler | `8.x` |
| ![Tailwind](https://img.shields.io/badge/-Tailwind-A4161A?style=flat-square&logo=tailwindcss&logoColor=F5F3F4&labelColor=161A1D) | Utility first styling, light and dark themes | `3.x` |
...
| ![TypeScript](https://img.shields.io/badge/-TypeScript-A4161A?style=flat-square&logo=typescript&logoColor=F5F3F4&labelColor=161A1D) | Landing page, Playwright specs, shared contracts | `5.x+` |
| ![Playwright](https://img.shields.io/badge/-Playwright-A4161A?style=flat-square&logo=playwright&logoColor=F5F3F4&labelColor=161A1D) | Both component-level unit tests and end to end tests | `1.60+` |
...
| Technology | Purpose | Version |
|:---|:---|:---:|
| ![PyInstaller](https://img.shields.io/badge/-PyInstaller-A4161A?style=flat-square&logo=python&logoColor=F5F3F4&labelColor=161A1D) | Freezes the backend, CV pipeline and simulator client into one binary | `6.21+` |
| ![Electron](https://img.shields.io/badge/-Electron-A4161A?style=flat-square&logo=electron&logoColor=F5F3F4&labelColor=161A1D) | Desktop shell. `electron-builder` produces `.exe` and `.AppImage` | `43.x` |
...
| Technology | Purpose |
|:---|:---|
| ![uv](https://img.shields.io/badge/-uv-A4161A?style=flat-square&logo=astral&logoColor=F5F3F4&labelColor=161A1D) | Single root workspace resolves backend, services and vendored packages together |
| ![Task](https://img.shields.io/badge/-Task-A4161A?style=flat-square&logo=task&logoColor=F5F3F4&labelColor=161A1D) | Cross platform task runner. Same commands on Windows, macOS, Linux |
| ![Ruff](https://img.shields.io/badge/-Ruff-A4161A?style=flat-square&logo=ruff&logoColor=F5F3F4&labelColor=161A1D) | Python lint and format. Single quotes, tab indent, 100 col, `E/F/I/N` rules |
| ESLint plus Prettier | TypeScript and JSX linting and formatting. `format:check` gates CI |
| ![GitHub Actions](https://img.shields.io/badge/-GitHub_Actions-A4161A?style=flat-square&logo=github-actions&logoColor=F5F3F4&labelColor=161A1D) | Test, lint, docs deploy and release build pipelines |
| ![Codecov](https://img.shields.io/badge/-Codecov-A4161A?style=flat-square&logo=codecov&logoColor=F5F3F4&labelColor=161A1D) | Coverage reporting. Separate `backend` and `services` flags, 80% target |
| ![Git](https://img.shields.io/badge/-Git-A4161A?style=flat-square&logo=git&logoColor=F5F3F4&labelColor=161A1D) | Version control. Trunk based, Use Case branches, submodule for vendors |
...
<table>
  ...
  <tr>
    ...
    <td align="center"><img src="https://img.shields.io/badge/LOW-660708?style=flat-square&labelColor=161A1D"/></td>
    <td align="center">Implemented</td>
  </tr>
  <tr>
...
[![Python](https://img.shields.io/badge/Python-3.11.x-A4161A?style=flat-square&logo=python&logoColor=F5F3F4&labelColor=161A1D)](https://python.org)
[![uv](https://img.shields.io/badge/uv-0.11+-A4161A?style=flat-square&logoColor=F5F3F4&labelColor=161A1D)](https://docs.astral.sh/uv/)
[![Task](https://img.shields.io/badge/Task-3.x-A4161A?style=flat-square&logo=task&logoColor=F5F3F4&labelColor=161A1D)](https://taskfile.dev)
[![Node](https://img.shields.io/badge/Node.js-22-A4161A?style=flat-square&logo=node.js&logoColor=F5F3F4&labelColor=161A1D)](https://nodejs.org)
[![Yarn](https://img.shields.io/badge/Yarn-1.22+-A4161A?style=flat-square&logo=yarn&logoColor=F5F3F4&labelColor=161A1D)](https://yarnpkg.com)
...
flowchart LR
    main(["main"]):::main
    dev(["dev"]):::dev
    uc(["Use-Case-N/Topic"]):::uc
    feat(["feature/UCN/name"]):::feat
    ...
    classDef main fill:#660708,color:#F5F3F4,stroke:none
    classDef dev  fill:#A4161A,color:#F5F3F4,stroke:none
    classDef uc   fill:#BA181B,color:#F5F3F4,stroke:none
...
<table>
  ...
  <tr>
    ...
    <td><a href="https://github.com/COS301-SE-2026/Gesture-Based-Drone-Control/actions/workflows/test.yml"><img src="https://img.shields.io/github/actions/workflow/status/COS301-SE-2026/Gesture-Based-Drone-Control/test.yml?style=flat-square&logo=github-actions&logoColor=F5F3F4&color=A4161A&labelColor=161A1D"/></a></td>
  ...
  <tr>
    ...
    <td><a href="https://github.com/COS301-SE-2026/Gesture-Based-Drone-Control/actions/workflows/release.yml"><img src="https://img.shields.io/github/actions/workflow/status/COS301-SE-2026/Gesture-Based-Drone-Control/release.yml?style=flat-square&logo=github-actions&logoColor=F5F3F4&label=release&color=BA181B&labelColor=161A1D"/></a></td>
  ...
  <tr>
    ...
    <td><a href="https://codecov.io/gh/COS301-SE-2026/Gesture-Based-Drone-Control"><img src="https://img.shields.io/codecov/c/github/COS301-SE-2026/Gesture-Based-Drone-Control?style=flat-square&logo=codecov&logoColor=F5F3F4&color=BA181B&labelColor=161A1D"/></a></td>
  ...
  <tr>
    <td><b>Issues</b></td>
    <td><a href="https://github.com/COS301-SE-2026/Gesture-Based-Drone-Control/issues"><img src="https://img.shields.io/github/issues/COS301-SE-2026/Gesture-Based-Drone-Control?style=flat-square&logo=github&color=E5383B&labelColor=161A1D"/></a></td>
...
<img src="https://komarev.com/ghpvc/?username=codex-merchants&label=Repo+views&color=A4161A&style=flat-square" alt="Profile views"/>
