# /services/cv-pipeline/gesture_engine.py
...
"""
    ...
    Retruns GestureEngineResult with per-hand GestureResults
...
from mediapipe_detector import HandDetectionResult

#recognizer imports
from recognizers.gesture_recognizer import GestureRecognizer
from recognizers.rule_based import GestureResult, RuleBasedRecognizer
...
class GestureEngineResult:
    ...
    #one GestureResult perr detected hand
...
class GestureEngine:
    """
        ...
        Default will be rule-bassed
    """
    
    def __inti__(self, recognizer: GestureRecognizer = None) -> None:
    ...
    def set_recognizer(self, recognizer: GestureRecognizer) -> None:
        """
            ...
            Allows switching between rule-based and ml wihtout restarting
        """
    ...
    def process(self, detection_result: HandDetectionResult) -> GestureEngineResult:
        ...
        if not detection_result.has_hands:
            logger.debug("No hands in frame %d - skipping gesture recognition",
