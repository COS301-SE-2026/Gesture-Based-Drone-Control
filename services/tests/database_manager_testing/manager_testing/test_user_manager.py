...
async def test_create_builds_user_with_hashed_password(mock_user_cls, mock_hash_password, manager, db):
...
@patch("services.database_manager.managers.user_manager.hash_password")
@patch("services.database_manager.managers.user_manager.User")
async def test_create_never_stores_plaintext_password(mock_user_cls, mock_hash_password, manager, db):
    mock_hash_password.return_value = "hashed_pw"
